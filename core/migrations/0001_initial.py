    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mcu_objects', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='object_parent', to='core.baseobject', to_field='index')),
                ('mcu_targets', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='target_parent', to='core.baseobject', to_field='index')),
            ],
        ),
    ]
